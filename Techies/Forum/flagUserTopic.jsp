...
int userflag=0;
            ...
            stmt=cn.prepareStatement("select * from topic where topic_id='"+topicid+"'");
            ...
            stmt1=cn.prepareStatement("UPDATE topic SET flags=? where topic_id='"+topicid+"'");
            stmt2=cn.prepareStatement("UPDATE topic SET name1='"+fby+"' where topic_id='"+topicid+"'");
            ...
            stmt1=cn.prepareStatement("UPDATE topic SET flags=? where topic_id='"+topicid+"'");
            stmt2=cn.prepareStatement("UPDATE topic SET name2='"+fby+"' where topic_id='"+topicid+"'");
            stmt3=cn.prepareStatement("UPDATE general_users set flags=? where username='"+uname+"'");
            stmt1.setInt(1,count);
            stmt3.setInt(1,userflag);
            stmt1.executeUpdate();
            ...
            stmt1=cn.prepareStatement("UPDATE topic SET flags=? where topic_id='"+topicid+"'");
            stmt2=cn.prepareStatement("UPDATE topic SET name3='"+fby+"' where topic_id='"+topicid+"'");
            stmt3=cn.prepareStatement("UPDATE general_users set flags=? where username='"+uname+"'");
            stmt1.setInt(1,count);
            stmt3.setInt(1,userflag);
            stmt1.executeUpdate();
            ...
            stmt4=cn.prepareStatement("select * from topic where topic_id='"+topicid+"'");
            ResultSet rs4=stmt4.executeQuery();
            rs4.next();
            if(rs4.getInt(6)>=3){          
            stmt5=cn.prepareStatement("delete from topic where topic_id='"+topicid+"'");
            stmt5.executeUpdate();
            }
